            ...
            <div class="col-xs-12">
                ...
                <div class="contactUs__container">
                    ...
                    <div class="form-row">
                        <div class="row">
                            <div class="col-sm-12">
                                <?= $form->field($model, 'subject', ['template' => '{label} <span class="-required"></span> {input} {error}'])->dropDownList(Message::getSubjects(), ['tabindex' => 1]) ?>
                        ...
                        <?= $form->field($model, 'body', ['options' => ['class' => 'form-group col-lg-12', 'template' => '{label} <span class="-required"></span> {input} {error}']])->textarea(['tabindex' => 9, 'rows' => 8]) ?>
