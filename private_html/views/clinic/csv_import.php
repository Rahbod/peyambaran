...
$this->title = Yii::t('words', 'Import csv program');
...
<div class="m-portlet m-portlet--tab">
    ...
    <div class="m-portlet__body">
        ...
        <?php echo $form->field($model, 'csv_file')->widget(\devgroup\dropzone\DropZone::className(), [
            'url' => Url::to(['upload-csv']),
            'removeUrl' => Url::to(['delete-csv']),
            'storedFiles' => isset($file) ? $file : [],
            'sortable' => false, // sortable flag
            'sortableOptions' => [], // sortable options
            'htmlOptions' => ['class' => 'single', 'id' => Html::getInputId($model, 'csv_file')],
            'options' => [
