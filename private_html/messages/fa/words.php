...
(برای ارسال پاسخ آزمایشات و تصویربرداری می‌توانید از فرم ارسال مدارک پزشکی و پیوست استفاده کنید)',
    ...
    'Unequal' => 'ناباروری',
    'Sleep clinic' => 'کلینیک خواب',
    'Wound clinic' => 'کلینیک زخم',
    'Laboratory' => 'آزمایشگاه',
    'Imaging' => 'تصویربرداری',
    'Nuclear medicine' => 'پزشکی هسته ای',
    'Digestive and scooby' => 'گوارش و اسکوبی',
    'Physiotherapy and rehabilitation' => 'فیزیوتراپی و توانبخشی',
    'Dentistry and Orthodontics' => 'دندانپزشکی و ارتودنسی',
    'Clinic of Health and Lifestyle Improvement' => 'دندانپزشکی و ارتودنسی',
