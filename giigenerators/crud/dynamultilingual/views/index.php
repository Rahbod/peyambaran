...
use <?= $generator->indexWidgetType === 'grid' ? "\\app\\components\\customWidgets\\CustomGridView" : "yii\\widgets\\ListView" ?>;
    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
            ...
            <div id="m_table_1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                <?php if ($generator->indexWidgetType === 'grid'): ?><?= "<?= " ?>CustomGridView::widget([
